 ...
 */
final class Version20211005122944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, lieu_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, creneaux_debut DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', creneaux_fin DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', libelle_produit VARCHAR(50) NOT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, quantite INT NOT NULL, INDEX IDX_F65593E56AB213CC (lieu_id), INDEX IDX_F65593E5BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE producteur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, tel VARCHAR(16) NOT NULL, mail VARCHAR(50) NOT NULL, mdp VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE administrateur ADD CONSTRAINT FK_32EB52E8AB9BB300 FOREIGN KEY (producteur_id) REFERENCES producteur (id)');
        ...
        $this->addSql('ALTER TABLE lieu_producteur ADD CONSTRAINT FK_2BB1AFA4AB9BB300 FOREIGN KEY (producteur_id) REFERENCES producteur (id) ON DELETE CASCADE');
    }
